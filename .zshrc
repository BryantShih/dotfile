...
export ZSH=/Users/haohsinshih/.oh-my-zsh
...
export PATH="/usr/local/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/texbin:/usr/local/mysql/bin:$PATH"
